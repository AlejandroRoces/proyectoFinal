            ...
            <main>
                <div class="container mt-4">
                    ...
                    <div class="list-group">
                        <!-- Opción Rastreos -->
                        <a href="#" class="list-group-item list-group-item-action menu-opcion" onclick="toggleActividades('actividadesRastreos')">Rastreos</a>
                        <div id="actividadesRastreos" class="actividad-contenedor">
                        ...
                        <!-- Opción Gymkanas -->
                        <a href="#" class="list-group-item list-group-item-action menu-opcion" onclick="toggleActividades('actividadesGymkanas')">Gymkanas</a>
                        <div id="actividadesGymkanas" class="actividad-contenedor">
                            <a href="actividad.html?actividad=deportes" class="list-group-item list-group-item-action actividad-item">Gymkana guarra</a>
                            <a href="actividad.html?actividad=juegos" class="list-group-item list-group-item-action actividad-item">Gymkana acuática</a>
                        ...
                        <!-- Opción Juegos -->
                        <a href="#" class="list-group-item list-group-item-action menu-opcion" onclick="toggleActividades('actividadesJuegos')">Juegos</a>
                        <div id="actividadesJuegos" class="actividad-contenedor">
                            <a href="actividad.html?actividad=deportes" class="list-group-item list-group-item-action actividad-item">Juegos olímpicos</a>
