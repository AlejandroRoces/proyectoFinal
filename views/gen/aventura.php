...
<body>
    ...
    <ul>
        <li>🚵‍♂️ **Rutas de senderismo y BTT** entre paisajes espectaculares.</li>
        <li>🧗 **Escalada y vías ferratas** para los más aventureros.</li>
        <li>🏞️ **Parajes naturales impresionantes** como los Hoces de Vegacervera.</li>
        <li>🌿 **Contacto directo con la naturaleza** en un entorno único.</li>
        <li>❄️ **Deportes de invierno** gracias a la cercanía de la estación de esquí de Pajares.</li>
    </ul>
    <p>
